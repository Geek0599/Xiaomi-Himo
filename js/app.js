...
let slider_about = new Swiper('.main-photo__slider', {
	effect: 'coverflow',
	autoplay: {
		delay: 5000,
...
let slider_carysel = new Swiper('.slider__body', {
	effect: 'coverflow',
	autoplay: {
		delay: 5000,
